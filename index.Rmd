 ...
 * [**Topic 2:**](https://jeremymack-lu.github.io/rviz/#29) Static visualizations
 
 * [**Topic 3:**](https://jeremymack-lu.github.io/rviz/#123) Dynamic visualizations
 
 * [**Topic 4:**](https://jeremymack-lu.github.io/rviz/#154) Shiny Apps - a preview
...
geom_point(mapping=aes(x=eruptions,
                       y=waiting)) +
geom_smooth(mapping=aes(x=eruptions,
                       y=waiting),
            method="lm")
...
states_sf %>%
    ...
    ggplot() +
    geom_sf(size=0.2,fill='lightblue') +
    ggthemes::theme_map()
```
]
